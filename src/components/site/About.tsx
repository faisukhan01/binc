            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="leading-tight">
                    ...
                    <p className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground">
                      {isUr ? UR.about.badgeFoundation : "Registered Foundation"}
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <p className="font-display text-2xl font-black leading-none">
                  100% <span className="text-gold-300">{isUr ? UR.about.badgeFree : "Free"}</span>
                </p>
          ...
          <div className="order-1 lg:order-2">
            <SectionHeading
              ...
              title={
                isUr ? (
                  <>
                    {UR.about.titleA} <span className="text-gradient-navy-red">{UR.about.titleB}</span>
                  </>
                ) : (
                  <>
