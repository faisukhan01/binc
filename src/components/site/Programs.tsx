      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        <SectionHeading
          ...
          title={
            isUr ? (
              <>
                {UR.programs.titleA} <span className="text-gradient-navy-red">{UR.programs.titleB}</span> {UR.programs.titleC}
              </>
            ) : (
              <>
                ...
                <div className="flex flex-1 flex-col p-6">
                  ...
                  <div className="mt-auto grid grid-cols-[1.3fr_1fr] gap-2">
                    ...
                    >
                      ...
                      <ArrowRight className="size-4 transition-transform duration-300 group-hover/btn:translate-x-1.5 rtl-mirror" />
                    </a>
                    <button
                      onClick={() => setActive(p)}
